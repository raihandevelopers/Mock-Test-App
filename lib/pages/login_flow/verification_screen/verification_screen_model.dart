...
class VerificationScreenModel
  ...
  // Stores action output result for [Backend Call - API (UserforgotpasswordverificationApi)] action in Button widget.
  ApiCallResponse? message;
  // Stores action output result for [Backend Call - API (UserforgotpasswordApi)] action in RichText widget.
